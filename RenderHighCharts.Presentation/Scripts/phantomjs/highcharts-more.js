    ...
    h.arearange = v(h.area, {
        ...
        drawDataLabels: function () {
            ...
            if (f.enabled || this._hasPointLabels) {
                for (c = b; c--;)
                    if (g = a[c])
                        if (l = g.plotHigh > g.plotLow, g.y = g.high, g._plotY = g.plotY, g.plotY = g.plotHigh, d[c] = g.dataLabel,
                ...
                for (c = b; c--;)
                    if (g = a[c])
                        if (l = g.plotHigh > g.plotLow, g.dataLabelUpper = g.dataLabel, g.dataLabel = d[c], g.y = g.low, g.plotY = g._plotY, g.below = !l, m) {
    ...
    h.boxplot = v(h.column, {
        ...
        drawPoints: function () {
            var a = this,
                ...
                c = a.options,
                d = a.chart.renderer,
                e, f, i, g, l, m, j, n, h, A, k, J, p, o,
                u, r, v, s, w, x, z, y, F = a.doQuartiles !== !1,
            ...
            t(b, function (b) {
                ...
                y = b.color || a.color;
                if (b.plotY !== D)
                    if (e = b.pointAttr[b.selected ? "selected" : ""], v = z.width, s = B(z.x), w = s + v, x = E(v / 2), f = B(F ? b.q1Plot : b.lowPlot), i = B(F ? b.q3Plot : b.lowPlot), g = B(b.highPlot), l = B(b.lowPlot), k.stroke = b.stemColor || c.stemColor || y, k["stroke-width"] = q(b.stemWidth, c.stemWidth, c.lineWidth), k.dashstyle = b.stemDashStyle || c.stemDashStyle, o.stroke = b.whiskerColor || c.whiskerColor ||
    ...
    M.prototype.beforePadding = function () {
        ...
        t(this.series, function (b) {
            ...
            if (b.bubblePadding && (b.visible || !c.options.chart.ignoreHiddenSeries))
                if (a.allowZoomOutside = !0, p.push(b), f) t(["minSize", "maxSize"], function (a) {
                    var b = g[a],
                        f = /%$/.test(b),
                        b = x(b);
                    l[a] = f ? m * b / 100 : b
        ...
        t(p, function (a) {
            ...
            if (h > 0)
                for (; c--;) typeof b[c] === "number" && (m = a.radii[c], d = Math.min((b[c] - g) * k - m, d), e = Math.max((b[c] - g) * k + m, e))
        });
